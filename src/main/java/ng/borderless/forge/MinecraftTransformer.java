package ng.skyiswinni.borderless.forge;
    ...
    public void transform(ClassNode classNode, String name) {
        for (MethodNode method : classNode.methods) {
            ...
            if (methodName.equals("toggleFullscreen") || methodName.equals("func_71352_k")) {
                ...
                insnList.add(new MethodInsnNode(Opcodes.INVOKESTATIC, "ng/skyiswinni/borderless/BorderlessFullscreen", "apply", "()Z", false));
